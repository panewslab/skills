...
| Skill                                                  | Description                                                                             |
| ------------------------------------------------------ | --------------------------------------------------------------------------------------- |
| [panews](skills/panews/SKILL.md)                       | Query the public PANews API for structured article search, listings, rankings, and must-reads |
...
| Need | Use |
| ---- | --- |
| Search articles, list content, fetch rankings, or get daily must-reads as JSON | [panews](skills/panews/SKILL.md) |
